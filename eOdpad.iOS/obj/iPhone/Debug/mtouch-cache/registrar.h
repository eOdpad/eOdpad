...
@class eOdpad_iOS_Renderers_MyListViewRenderer;
@class Xamarin_Forms_Platform_iOS_BoxRenderer;
@class eOdpad_iOS_Renderers_MyBoxViewRender;
...
@interface eOdpad_iOS_Renderers_MyListViewRenderer : Xamarin_Forms_Platform_iOS_ListViewRenderer {
}
	-(id) init;
@end
...
@interface eOdpad_iOS_Renderers_MyBoxViewRender : Xamarin_Forms_Platform_iOS_BoxRenderer {
}
	-(id) init;
@end
